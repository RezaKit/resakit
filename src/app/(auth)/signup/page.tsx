      ...
      <div className="hidden md:flex md:w-1/2 bg-[#141414] flex-col justify-between p-14 xl:p-20">
        ...
        <div>
          <h2 className="font-serif italic text-[52px] xl:text-[60px] leading-[0.95] text-white mb-8" style={{ letterSpacing: -1.5 }}>
            Rejoins <em className="text-[#7C3AED]">l&apos;aventure</em> collective.
          </h2>
          <div className="flex flex-col gap-4">
            {[
              { icon: '🎯', title: 'Expériences uniques', desc: 'EVJF, anniversaires, team building — on a tout.' },
              { icon: '💳', title: 'Split payment natif', desc: 'Invite ta bande. Chacun règle sa part en ligne.' },
              { icon: '📲', title: 'Zéro application', desc: 'Tout se passe dans le navigateur. Simple.' },
            ].map((f) => (
        ...
        <div className="p-5 rounded-2xl bg-white/6 border border-white/10">
          <p className="text-[13.5px] text-white/80 leading-relaxed italic">
            &ldquo;On cherchait une activité pour un team building de 20 personnes. Trouvé, réservé et payé en moins d&apos;une heure.&rdquo;
          </p>
          <div className="flex items-center gap-3 mt-4">
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#F97316] to-[#7C3AED] flex items-center justify-center text-[12px] font-bold text-white">
              T
            </div>
            <div>
              <div className="text-[13px] font-semibold text-white">Thomas R.</div>
              <div className="text-[11px] text-white/45">Team building · Bordeaux · 20 personnes</div>
            </div>
          </div>
        </div>
      </div>
